...
from . import agents, ik_abs_env_cfg, ik_rel_env_cfg, joint_pos_env_cfg, joint_pos_env_cfg_soft
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": joint_pos_env_cfg_soft.FrankaSoftLiftEnvCfg,
