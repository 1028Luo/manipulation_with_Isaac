...
# Modified from the original franka_cabinet_env.py
...
@configclass
class ManipulateSoftDirectCfg(DirectRLEnvCfg):
    # env
...
############### def soft objects cfg

    soft = DeformableObjectCfg(
        prim_path="/World/envs/env_.*/Soft",
...
class ManipulateSoftDirect(DirectRLEnv):
    ...
    cfg: ManipulateSoftDirectCfg

    def __init__(self, cfg: ManipulateSoftDirectCfg, render_mode: str | None = None, **kwargs):
    ...
    def _setup_scene(self):
        ...
        # add soft objects
        self._soft = DeformableObject(self.cfg.soft) # aaa
        self.scene.deformable_objects["soft"] = self._soft # aaa
